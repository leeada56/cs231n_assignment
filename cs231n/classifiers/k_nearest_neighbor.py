  ...
  def compute_distances_two_loops(self, X):
    ...
    for i in xrange(num_test):      
      for j in xrange(num_train):
        ...
        #####################################################################
        # print "(i,j)= ( ", i , " ", j ," )"                
        # print self.X_train[j], self.X_train[j].shape[0]
        # print X[i], X[i].shape[0]
        # sqr = np.square(self.X_train[j,:] - X[i])
        # print sqr, sqr.shape[0]
        # dist_sum = np.sum(sqr)
        # print dist_sum
        ...
        # raw_input()
        # print dists
        # raw_input("press enter to continune")
        # min_index = np.argmin(dist) # get the index with smallest distance
